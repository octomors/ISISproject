  ...
  return (
    <div className="mx-auto max-w-4xl px-8 py-12">
      ...
      <div className="mb-6 rounded-xl border border-[var(--secondary)] bg-[var(--surface)] p-8 shadow-sm">
        ...
        <div className="mb-8">
          <label className="mb-3 block text-sm font-mono">Название задачи</label>
          <input
            ...
            placeholder="Например: Оптимизация подсчёта топ-N"
          />
        </div>

        <div className="mb-8">
          <label className="mb-3 block text-sm font-mono">Язык программирования</label>
          <input
            value={createTaskDraft.programmingLanguage}
            onChange={(event) =>
              setCreateTaskDraft((prev) => ({
                ...prev,
        ...
        <div className="mb-8 rounded-lg border border-[var(--secondary)] bg-[var(--background)] p-6">
          <FolderGit2 className="mb-3 h-8 w-8 text-indigo-500" />
          <label className="mb-3 block text-sm font-mono">URL репозитория задачи</label>
          <input
            ...
            className="w-full rounded-md border border-[var(--secondary)] bg-[var(--surface)] p-3 font-mono text-sm text-[var(--text)] outline-none transition focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--surface-hover)]"
        ...
        <div className="mb-8">
          ...
          <textarea
            ...
            className="min-h-44 w-full rounded-md border border-[var(--secondary)] bg-[var(--background)] p-4 font-mono text-sm text-[var(--text)] outline-none transition focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--surface-hover)]"
